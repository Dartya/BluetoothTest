        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == menuIndex++) {
                    final ProgressDialog pd = ProgressDialog.show(Main.this, "", "Тяжелая работа, пожалуйста, подождите......");
                    ...
                    UserInfo userInfo = new UserInfo(20271234, 1, 32, 160, 40, "1 ха-ха", 0);
